...
class RiwayatPekerjaan extends \App\Controllers\BaseController
{
	protected $model;
	public function __construct() {
		...
		$this->model = new RiwayatPekerjaanModel;	
		$this->data['site_title'] = 'Riwayat Pekerjaan';
	...
	public function index()
	{
		...
		$this->view('../../Talent/RiwayatPekerjaan/RiwayatPekerjaanView', $data);
	}
