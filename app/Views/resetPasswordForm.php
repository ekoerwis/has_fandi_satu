            ...
            <div class="card-body" >
                ...
                if (@$register_status != 'register_sukses') {
                    ...
                    <div class="mb-1">
                        ...
                        <p class="small">Alamat email untuk permintaan reset password</p>
                    </div>
                    <div class="mb-1" style="margin-bottom:0">
                        <button type="submit" name="submit" value="submit" class="btn btn-success" style="display:block;width:100%">Reset Password</button>
                    </div>
                </form>
